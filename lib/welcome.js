...
const { getRandom, smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, delay, sleep } = require('./node_modules/Arisu-MD/myfunc');
const { isSetWelcome, getTextSetWelcome } = require('./node_modules/Arisu-MD/setwelcome');
const { isSetLeft, getTextSetLeft } = require('./node_modules/Arisu-MD/setleft');
