...
async function addweb(m, RyuuBotz, text, prefix, reply, qmsg, isRyuuTheCreator, mess, example) {
...
async function delweb(m, RyuuBotz, text, reply, isRyuuTheCreator, mess) {
  if (!isRyuuTheCreator) return reply(mess.only.owner);
...
async function listweb(m, reply, isRyuuTheCreator, mess) {
  if (!isRyuuTheCreator) return reply(mess.only.owner);
...
async function gethtml(m, RyuuBotz, text, reply, isRyuuTheCreator, mess) {
  if (!isRyuuTheCreator) return reply(mess.only.owner);
